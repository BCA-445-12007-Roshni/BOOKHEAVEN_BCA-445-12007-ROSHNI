...
const cookieOptions = {
  ...
  sameSite: process.env.APP_ENV === "production" ? "none" : "strict", //Controls when cookies are sent "none" allows cross-site in production, "strict"
};
...
export const userRegister = async (req, res) => {
  try {
    ...
    //Checking if user is already exit or not
