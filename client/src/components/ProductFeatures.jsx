...
const ProductFeatures = () => {
  return (
    <div className="mt-12 bg-primary rounded-lg">
      <div className="grid grid-cols sm:grid-cols-2 lg:grid-cols-3 gap-12 rounded-xl">
        <div className="flexCenter gap-x-4 p-2 rounded-3xl">
          ...
          <div>
            ...
            <p>
              ...
              voluptates molestiae culpa ea nulla consequuntur voluptatum illo
              velit a quod, autem soluta.
            </p>
          </div>
        </div>
        <div className="flexCenter gap-x-4 p-2 rounded-3xl">
