        ...
        <Navbar
          ...
          containerStyles={`${
            menuOpened
              ...
              : "hidden lg:flex gap-x-5 xl:gap-x-7 medium-15 ring-1 ring-1 ring-slat-900/15 rounded-full p-1 bg-primary"
          }`}
        />
      </div>
        ...
        <div className="group relative">
          <div>
            {user ? (
              ...
              <button onClick={()=>setShowUserLogin(true)} className="btn-light flexCenter gap-x-2">
                Login <RiUserLine classNam="text-xl" />
              </button>
            )}
          </div>
          {/* DROPDOWN */}
