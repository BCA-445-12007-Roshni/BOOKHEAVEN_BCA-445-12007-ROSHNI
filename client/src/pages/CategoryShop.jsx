    ...
    <div className="max-padd-container py-16 pt-28">
      ...
      <div className="flexCenter flex-wrap gap-2 sm:gap-4 mt-14 mb-10">
        <button
          ...
          className={`${currPage === 1 && "opacity-50 cursor-not-allowed"} btn-dark !py-1 !py-3`}
        >
          Previous
        </button>
        ...
        <button
          ...
          onClick={() => setCurrPage((prev) => prev + 1)}
          className={`${currPage === totalPages && "opacity-50 cursor-not-allowed"} btn-white bg-tertiary !py-1 !py-3`}
        >
          Next
        </button>
      </div>
