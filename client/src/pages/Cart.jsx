            ...
            if (quantity > 0) {
              return (
                <div key={book._id} className='grid grid-cols-[6fr_1fr_2fr] items-center bg-primary p-2 rounded-lg'>
                  <div className='flex items-center md:gap-6 gap-3'>
                    ...
                    <div>
                      ...
                      <div className='flexBetween mt-2'>
                        <div className='flex items-center ring-1 ring-slat-900/5 p-0.5 rounded-full overflow-hidden bg-white'>
                  ...
                  <button onClick={()=>updateQuantity(book._id,0)} className='cursor-pointer mx-auto hold-14 text-secondary'>delete</button>
                </div>
              )
            }
            return null
